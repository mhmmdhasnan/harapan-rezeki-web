...
@section('content')
    ...
    @if ($services && $services->count() > 0)
        @php
            ...
            $otherServices = $services->whereNotIn('name', [
                'BOGA (Catering)',
                'INSTALASI & CONFIGURE',
                'EQUIPMENT EVENT',
            ]);
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl">
                            @foreach ($mainServices as $service)
                                <div
                                    ...
                                    <p class="text-gray-600 leading-relaxed text-center mb-6">{{ $service->description }}
                                    </p>
                                </div>
                            @endforeach
                        </div>
                    ...
                    <div class="flex justify-center">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl">
                            @foreach ($otherServices as $service)
                                <div
                                    class="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition transform hover:-translate-y-2">
                                    <div class="text-6xl mb-6 text-center">{{ $service->icon ?? '🔧' }}</div>
                                    <h3 class="text-xl font-semibold mb-4 text-gray-800 text-center">{{ $service->name }}
                                    </h3>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="bg-white p-8 rounded-lg shadow-lg text-center hover:shadow-xl transition">
                    ...
                    <p class="text-gray-600 leading-relaxed">Menerapkan Manajemen mutu serta pengendalian waktu dan biaya
                        secara efisien</p>
                </div>
                <div class="bg-white p-8 rounded-lg shadow-lg text-center hover:shadow-xl transition">
                    <div class="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-gray-600 leading-relaxed">Mengutamakan standar kualitas tinggi dalam setiap produk dan
                        layanan yang kami berikan untuk kepuasan pelanggan</p>
                </div>
                <div class="bg-white p-8 rounded-lg shadow-lg text-center hover:shadow-xl transition">
                    <div class="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <span class="text-3xl">👥</span>
                    ...
                    <p class="text-gray-600 leading-relaxed">Profesionalitas dalam kerja sebagai jaminan bagi integritas
                        perusahaan</p>
                </div>
                <div class="bg-white p-8 rounded-lg shadow-lg text-center hover:shadow-xl transition">
                    <div class="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <p class="text-gray-600 leading-relaxed">Terus berinovasi dengan kreatifitas & teknologi demi karya yang
                        sesuai dengan tuntutan zaman</p>
                </div>
            </div>
        </div>
    </section>
