...
<section class="bg-gradient-to-r from-red-900 to-red-950 text-white relative overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-30">
        <div class="absolute -top-10 -left-10 w-96 h-96" style="background-image: url('{{ asset('images/dayak-motif.svg') }}'); background-size: contain; background-repeat: no-repeat;"></div>
        <div class="absolute -bottom-10 -right-10 w-96 h-96" style="background-image: url('{{ asset('images/dayak-motif.svg') }}'); background-size: contain; background-repeat: no-repeat; transform: rotate(180deg);"></div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
        <div class="text-center">
            ...
            <div class="space-x-4">
                <a href="{{ route('services') }}" class="inline-block bg-white text-red-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">Lihat Layanan</a>
                <a href="{{ route('contact') }}" class="inline-block border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-red-900 transition">Hubungi Kami</a>
            </div>
        </div>
    </div>
</section>
...
<section class="py-16 bg-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mt-8">
            <a href="{{ route('services') }}" class="text-red-900 hover:text-red-950 font-semibold">Lihat Semua Layanan →</a>
        </div>
    </div>
</section>
@endif
...
<section class="py-16 bg-red-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a href="{{ route('contact') }}" class="inline-block bg-white text-red-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition">Hubungi Kami</a>
    </div>
</section>
@endsection
